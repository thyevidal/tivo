        ...
        <div style={{ display: \'flex\', gap: \'8px\' }}>
          {isAdmin && (
            <Link href="/app/admin" style={{
              background: pathname.startsWith(\'/app/admin\') ? \'var(--green-400)\' : \'var(--surface-1)\',
          ...
          <Link href="/app/configuracoes" style={{
            background: pathname.startsWith(\'/app/configuracoes\') ? \'var(--green-400)\' : \'var(--surface-1)\',
            border: \'1px solid var(--border)\',
            borderRadius: \'50%\',
            width: \'36px\',
            height: \'36px\',
        ...
        {navItems.map(({ href, icon: Icon, label }) => {
          ...
          return (
            <Link key={href} href={href} style={{
              ...
              {isChat ? (
                <div style={{
                  background: active ? \'var(--green-400)\' : \'rgba(52, 211, 153, 0.1)\',
