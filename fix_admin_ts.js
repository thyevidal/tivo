...
function TabButton({ active, onClick, icon: Icon, label }: any) {
  return (
    <button onClick={onClick} style={{
      ...
      background: active ? \'rgba(52, 211, 153, 0.1)\' : \'var(--surface-1)\',
...
fs.writeFileSync('/Users/thye/Dev/tivo/app/app/admin/page.tsx', code)
console.log('Fixed TS errors in admin page')
